...
<template>
	<view class="search_history">
		...
		<view class="search_history_tags">
			<uni-tag v-for="(item,index) in historyList" @tap="navigateToShow(item)" :key="index" :text="item" size="small" :circle="true"></uni-tag>
		</view>
	</view>
</template>
...
<script lang="ts" setup>
	...
	// webView.setTitleNViewSearchInputText("123")
